    ...
    <div className="mx-3 py-5">
      <div className="relative w-full h-full border-1 border-gray-300 border-t-0 rounded-lg text-center">
        ...
        <div className="w-full sm:h-130 lg:h-190 mr-5">
          <img className="inset-0 w-full h-full object-cover" src={photoUrl} />
        </div>
          ...
          <div className="flex items-center justify-center bg-white">
            <div className="flex items-center space-x-4">
              <div className="border-y-1 border-gray-500 w-20 py-2">
                <span className="text-lg text-gray-600 font-serif">{dayText}</span>
              </div>
              <div className="flex items-center space-x-2 py-2">
                <span className="text-4xl text-gray-600 font-serif">{dayMonth}</span>
              </div>
              <div className="border-y-1 border-gray-500 w-20 py-2">
                <span className="text-lg text-gray-600 font-serif">{year}</span>
              </div>
            </div>
          </div>
        </div>
